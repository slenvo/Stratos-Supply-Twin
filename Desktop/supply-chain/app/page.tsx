...
export default function Dashboard() {
  ...
  return (
    <div className="flex h-screen bg-slate-950 text-white font-sans overflow-hidden">
      ...
      <div 
        style={{ width: leftWidth, minWidth: 250, maxWidth: 600 }} 
        className="bg-slate-900 flex flex-col z-20 shadow-2xl overflow-y-auto shrink-0"
      >
      ...
      <div 
        ...
        className={`w-1 cursor-col-resize hover:bg-blue-500 transition-colors z-30 flex-shrink-0 ${isDraggingLeft ? 'bg-blue-500' : 'bg-slate-800'}`}
      />

      {/* CENTER MAP */}
      <div className={`flex-1 relative ${isDraggingLeft || isDraggingRight ? 'pointer-events-none' : ''}`}>
        {isCalculating && (
      ...
      <div 
        ...
        className={`w-1 cursor-col-resize hover:bg-blue-500 transition-colors z-30 flex-shrink-0 ${isDraggingRight ? 'bg-blue-500' : 'bg-slate-800'}`}
      />

      {/* RIGHT SIDEBAR (Dynamic Width) */}
      <div 
        style={{ width: rightWidth, minWidth: 250, maxWidth: 600 }}
        className="bg-slate-900 flex flex-col z-20 shadow-2xl overflow-y-auto shrink-0"
      >
        <div className="p-5 flex-1 overflow-y-auto flex flex-col">
          <div className="mb-6">
